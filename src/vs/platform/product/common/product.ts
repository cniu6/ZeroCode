...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.104.0-dev',
			nameShort: 'ZeroCode Dev',
			nameLong: 'ZeroCode Dev',
			applicationName: 'zerocode',
			dataFolderName: '.zerocode',
			urlProtocol: 'zerocode',
			reportIssueUrl: 'https://github.com/cniu6/ZeroCode/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/cniu6/ZeroCode/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/cniu6/ZeroCode/blob/main/LICENSE.txt',
			defaultChatAgent: {
